...
_Note:_
The location of the configuration file was changed as version 1.12 as all configuration files related to the program should be under the same dectory. In previous versions the configuration file is located under `~/.config/redshift.conf`.
