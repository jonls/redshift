...
static KeySet * embeddedSpec (void)
{
	...
	keyNew ("/brightness/day", KEY_META, "default", "1.0", KEY_META, "description", "The screen brightness during daytime. If both day and night brightness are set, these will overrule the value of brightness.", KEY_META, "example", "0.8", KEY_META, "opt/arg", "required", KEY_META, "opt/long", "brightness-day", KEY_META, "type", "float", KEY_END),
	keyNew ("/brightness/night", KEY_META, "default", "1.0", KEY_META, "description", "The screen brightness during nighttime. If both day and night brightness are set, these will overrule the value of brightness.", KEY_META, "example", "0.8", KEY_META, "opt/arg", "required", KEY_META, "opt/long", "brightness-night", KEY_META, "type", "float", KEY_END),
	...
	keyNew ("/temp/day", KEY_META, "default", "6500", KEY_META, "description", "The color temperature the screen should have during daytime.", KEY_META, "example", "6500", KEY_META, "opt/arg", "required", KEY_META, "opt/long", "temp-day", KEY_META, "type", "unsigned_short", KEY_END),
	keyNew ("/temp/night", KEY_META, "default", "4500", KEY_META, "description", "The color temperature the screen should have during nighttime.", KEY_META, "example", "4500", KEY_META, "opt/arg", "required", KEY_META, "opt/long", "temp-night", KEY_META, "type", "unsigned_short", KEY_END),
	keyNew ("/temp/oneshotmanual", KEY_META, "default", "6500", KEY_META, "description", "The color temperature the screen should have when oneshotmanual mode is used.", KEY_META, "example", "6500", KEY_META, "opt/arg", "required", KEY_META, "opt/long", "temp-oneshotmanual", KEY_META, "type", "unsigned_short", KEY_END),
